...
begin
	...
	using VideoIO, Images, FileIO, Glob, JLD2, UnPack, CSV, DataFrames, LinearAlgebra, Hungarian
	using Plots
end
...
# ╔═╡ f4d7b20a-4f81-4e99-b76b-27385724f8e3
include("calibrate.jl")

# ╔═╡ 9896e1a1-5024-4f77-8a06-e7000b12fb2f
begin
	trace = PlutoPlotly.scatter3d(
        x = reconstructed_points[:, 1],
        y = reconstructed_points[:, 2],
        z = reconstructed_points[:, 3],
        mode = "markers",
        marker = attr(color = "blue", size = 3),
...
let
	points = vcat(reconstructed_points, (-R1' * t1)', (-R2' * t2)')
...
# ╔═╡ 6f991dc2-928e-452f-9e74-6a7919d2286b
(-R1' * t1)'

# ╔═╡ a9fc3efd-506a-4f0b-b667-9284b9d029c5
-R2' * t2

# ╔═╡ 2dd6afae-9f9b-4ba0-87a5-e027d56da8fa
...
manifest_format = "2.0"
project_hash = "8433b8c7e19be5b30b697e1cd27777ca1191b692"
